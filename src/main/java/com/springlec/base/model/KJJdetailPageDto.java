...
public class KJJdetailPageDto {
	...
	public KJJdetailPageDto(int pid, String pname, String pfilename, String pcontentfilename1, String pcontentfilename2,
			String pcontent, int pstock, int pprice, String pcategory, String insertdate) {
		super();
		this.pid = pid;
		this.pname = pname;
