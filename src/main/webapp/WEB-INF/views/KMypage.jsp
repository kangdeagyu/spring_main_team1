    ...
    <div class="col-4 custom-nav">
      <nav>
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="myreview?cid=${cid}">나의 리뷰</a>
          </li>
          <li class="nav-item">
...
<!-- 					<input type="button" value="중복확인" name="emailcheak" onclick="checkDuplicate()"> -->
				...
				<label>성별</label><br/>
					<input type="radio" name="cgender" value="male" ${dto.cgender == '0' ? 'checked' : ''} disabled> 남자<br/>
					<input type="radio" name="cgender" value="female" ${dto.cgender == '1' ? 'checked' : ''} disabled> 여자<br/>
